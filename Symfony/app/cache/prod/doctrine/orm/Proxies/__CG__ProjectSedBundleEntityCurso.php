 ...
 */
class Curso extends \Project\SedBundle\Entity\Curso implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setNoGrupo($noGrupo);
    }

    public function getNoGrupo()
    {
        $this->__load();
        return parent::getNoGrupo();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'noGrupo', 'docente', 'materia');
    }
